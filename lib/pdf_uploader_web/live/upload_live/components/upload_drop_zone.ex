defmodule PdfUploaderWeb.UploadLive.Components.UploadDropZone do
  ...
  def render(assigns) do
    ...
    <form id="upload-form" phx-submit="save" phx-change="validate" class="flex flex-col gap-4">
      <div class="border-2 border-dashed border-gray-200 rounded-xl p-6 bg-white transition-colors hover:border-purple-500 hover:bg-gray-50"
           phx-drop-target={@upload.ref} id="upload-container" phx-hook="UploadHandler">
          ...
          <div class="w-full">
            ...
            <div class="grid grid-cols-2 gap-3">
              ...
              <button type="button"
                ...
                <span class={[
                  "text-xs font-medium mt-2 transition-colors",
                  @mode == :folder && "text-purple-600" || "text-gray-600 group-hover:text-purple-600"
                ]}>Pasta</span>
              </button>
            </div>
          </div>
